...
alias rustscan='sudo docker run --rm --name rustscan --privileged -v /dev:/dev -v /home/master/.rustscan.toml:/home/rustscan/.rustscan.toml:ro rustscan/rustscan:2.1.1'
