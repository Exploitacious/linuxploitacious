...
# Host-specific content — COWORK deploy.ps1's clawd launcher and third-party
# tools like Intelligent Terminal — is written to the untracked
# profile.local.ps1 beside this file, NEVER into this tracked public profile.
# Sourced last so local definitions win; silent no-op when absent.
